...
Versión corregida para Windows - Sin emojis problemáticos
"""
...
class SimpleReportGenerator:
    ...
    def create_results_table_excel(self, results_data):
        ...
        print("[INFO] Creando TABLA XVII - Resultados de casos de prueba...")
    ...
    def create_metrics_table_excel(self, results_data):
        ...
        print("[INFO] Creando TABLA XVIII - Métricas de calidad final...")
    ...
    def create_csv_tables(self, results_data):
        ...
        print("[INFO] Creando archivos CSV...")
    ...
    def generate_thesis_summary(self, results_data):
        ...
        print("[INFO] Generando resumen para tesis...")
...
"""
    ...
    def create_simple_charts_data(self, results_data):
        ...
        print("[INFO] Generando datos para gráficos...")
    ...
    def generate_complete_report(self):
        ...
        print("RIOCAJA SMART - Generando reporte final completo...")
        print("="*60)
        ...
        try:
            ...
            print(f"\n[SUCCESS] Reporte completo generado en: {self.output_dir}")
            print(f"\n[FILES] Archivos creados:")
            print(f"   [EXCEL] {tabla_xvii.name} - TABLA XVII para tu tesis")
            print(f"   [EXCEL] {tabla_xviii.name} - TABLA XVIII para tu tesis")
            print(f"   [CSV] {csv_file.name} - Datos en CSV")
            print(f"   [TEXT] {thesis_summary.name} - Texto para copiar en tesis")
            print(f"   [JSON] {charts_data.name} - Datos para crear gráficos")
            
            # Mostrar métricas principales
            summary = results_data['test_summary']
            print(f"\n[METRICS] MÉTRICAS PRINCIPALES OBTENIDAS:")
